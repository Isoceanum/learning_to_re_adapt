...
from algorithms.base_trainer_old import BaseTrainer
from .dynamics import DynamicsModel  # deterministic MLP with normalization  # Added for Nagabandi fidelity
from algorithms.mb_mpc_old.buffer import ReplayBuffer
...
class MBMPCTrainerOld(BaseTrainer):
    """
    ...
    def _make_env(self):
        ...
        if n_envs > 1:
            ...
            try:
                ...
                # Older SB3 versions may not accept callable env builders or vec_env_cls argument
