...
RUN_DIR = "outputs/2026-03-02/ant_base"
EPISODES = 1
SEEDS = [1,2,3,4]

PERTURBATIONS = [
    {"type": "action_inversion", "probability": 1, "candidate_action_indices": [0]},
    {"type": "action_inversion", "probability": 1, "candidate_action_indices": [1]},
    {"type": "action_inversion", "probability": 1, "candidate_action_indices": [2]},
    {"type": "action_inversion", "probability": 1, "candidate_action_indices": [3]},
    {"type": "action_inversion", "probability": 1, "candidate_action_indices": [4]},
    {"type": "action_inversion", "probability": 1, "candidate_action_indices": [5]},
    {"type": "action_inversion", "probability": 1, "candidate_action_indices": [6]},
    {"type": "action_inversion", "probability": 1, "candidate_action_indices": [7]},
