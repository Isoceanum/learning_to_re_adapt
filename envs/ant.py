...
class AntEnv(MujocoEnv, utils.EzPickle):
    ...
    * v0: Initial versions release
    ...
    # Mapping from logical leg names to geom names that belong to that leg.
    # These names come directly from assets/ant.xml.
    LEG_GEOM_NAMES = {
    ...
    def get_model_reward_fn(self):
        ...
        # healthy_z_range is a tuple (min_z, max_z)
        ...
        def reward_fn(state, action, next_state):
            ...
            # contact_cost_weight=0 -> ignore contact cost
    ...
    def restore_disabled_legs(self):
        """Restore original geom sizes/colors after a crippled episode."""
    ...
    def disable_leg(self, leg_name: str):
        """
        Physically disable a leg by shrinking its geoms and tinting them red.
        This mirrors the treatment in Nagabandi et al. (2018) for crippled Ant tasks.
        """
        ...
        for geom_name in self.LEG_GEOM_NAMES[leg_name]:
            ...
            if idx is None:
                continue
            # Shrink cross-section to half to reduce contact/drag, keep positions
