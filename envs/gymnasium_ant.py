    ...
    * v0: Initial versions release
    ...
    def __init__(
        ...
        **kwargs,
        ...
        # Force contact forces out of the observation for simpler modeling.
        self._include_cfrc_ext_in_observation = False
    ...
    def get_model_reward_fn(self):
        ...
        qpos_size = int(self.observation_structure.get("qpos", 0))
        skip_qpos = int(self.observation_structure.get("skipped_qpos", 0))
        x_vel_index = qpos_size  # first qvel entry
        z_index = 0 if skip_qpos > 0 else 2
