...
class HalfCheetahEnv(MujocoEnv, utils.EzPickle):
    ...
    * v0: Initial versions release (1.0.0)
    ...
    def get_model_reward_fn(self):
        """
        Torch-compatible reward function for HalfCheetah.
        Mirrors the environment's step() reward:
        ...
        def reward_fn(state, action, next_state):
            ...
            # For HalfCheetah: root x-position is typically at index 0
            x_before = state[:, 0]
            ...
            # Total reward = forward - control cost
